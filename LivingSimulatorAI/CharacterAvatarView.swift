...
struct StylizedCharacterPortraitView: View {
    ...
    private var skinTintOverlay: Color {
        ...
        case 0: return Color(hex: "#FFE4D6").opacity(0.12)  // Fair
        case 1: return Color(hex: "#F5D0A9").opacity(0.10)  // Light
        case 2: return Color(hex: "#D89E62").opacity(0.16)  // Medium
        case 3: return Color(hex: "#A8652E").opacity(0.22)  // Tan
        case 4: return Color(hex: "#5C3012").opacity(0.30)  // Dark
    ...
    var body: some View {
        ...
        ZStack {
            ...
            // ── 2. High-Quality 3D Character Portrait Image ─────────
            Image(assetName)
                .resizable()
                .scaledToFill()
                .frame(width: size, height: size)
            ...
            // ── 4. Glasses Accessory Indicator Badge ────────────────
            if model.hasGlasses {
                VStack {
                    HStack {
                        Spacer()
                        Image(systemName: "eyeglasses")
                            ...
                            .clipShape(Circle())
                            .overlay(Circle().stroke(LVTheme.neon, lineWidth: 1))
                            .shadow(color: LVTheme.neon.opacity(0.5), radius: 6)
